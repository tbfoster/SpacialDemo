...
public final class SpacialMethodSource extends SpacialObject {
    ...
    //**************************************************************************
    public SpacialMethodSource(GL vgl, GLU vglu, float vX, float vY, float vZ)
    {
        super(vgl, vglu, vX, vY, vZ);
    }
    //**************************************************************************

    public SpacialMethodSource(GL vgl, GLU vglu, GLUT vglut, float vX, float vY, float vZ, String vDisplayMethod)
    {
        super(vgl, vglu, vX, vY, vZ);
        glut = vglut;
